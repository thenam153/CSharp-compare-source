...
public class ServerListScreen : mScreen, IActionListener
{
	...
	public override void paint(mGraphics g)
	{
		...
		int num2 = 2;
		mFont.tahoma_7_white.drawString(g, "v" + GameMidlet.VERSION, GameCanvas.w - 2, num2 + 15, 1, mFont.tahoma_7_grey);
	...
	public void perform(int idAction, object p)
	{
		...
		if (idAction == 8)
		{
			bool flag3 = (Rms.loadRMSInt("lowGraphic") == 1) ? true : false;
